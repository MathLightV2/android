...
class ListeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = ArrayAdapter(this,android.R.layout.simple_list_item_1, lesMemos())
    ...
    fun lesMemos(): Vector<String>
    {
        ...
        val osr = InputStreamReader(fis)
        val br = BufferedReader(osr)
        br.forEachLine { s -> vector.add(s) }
        br.close()
        return  vector
